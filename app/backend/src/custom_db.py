...
#         return error_response(405, message="DB Already linked, Please remove currently linked DB to add new")  

#     if not validate_mongo(uri.connection_uri):
#         return error_response(400, message="Invalid Mongo connection string")
...
#     logger.info(f"delete DB Link  request received from {current_user['email']}")
...
#         return error_response(405, message="DB not linked, nothing to delte")  
...
#     # Send confirmation email
#     bt.add_task(send_email, "QAB - DB Delte Successful", current_user['email'], "You have successfully delete your DB!")
#     logger.info(f"DB delete successfully for {current_user['email']}")
